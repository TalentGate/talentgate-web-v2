  ...
  return (
    <section className="grid items-start gap-6">
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.latitude || undefined}
          type="text"
          id="jobLocationLatitude"
      ...
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.longitude || undefined}
          type="text"
          id="jobLocationLongitude"
      ...
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.address.country || undefined}
          type="text"
          id="jobLocationAddressCountry"
          placeholder="Country"
          onChange={(e) => {
      ...
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.address.state || undefined}
          type="text"
          id="jobLocationAddressState"
          placeholder="State"
          onChange={(e) => {
      ...
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.address.city || undefined}
          type="text"
          id="jobLocationAddressCity"
          placeholder="City"
          onChange={(e) => {
      ...
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.address.street || undefined}
          type="text"
          id="jobLocationAddressStreet"
          placeholder="Street"
          onChange={(e) => {
      ...
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.address.unit || undefined}
          type="text"
          id="jobLocationAddressUnit"
          placeholder="Unit"
          onChange={(e) => {
      ...
      <div className="grid gap-2">
        ...
        <Input
          defaultValue={formData.location.address.postal_code || undefined}
          type="text"
          id="jobLocationAddressPostalCode"
      ...
      <div className="grid gap-2">
        ...
        <RadioGroup
          defaultValue={formData.location.type || 'Onsite'}
