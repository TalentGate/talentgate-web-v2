...
function Checkout({title, className, disabled}: { title: string, className?: string, disabled?: boolean }) {
    ...
    return (
        <Button disabled={disabled} onClick={handleCheckout} className={className}>{title}</Button>
    );
}
